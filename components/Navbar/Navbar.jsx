...
const TopNav = () => {
  ...
  return (
    <section id="topNav" className="bg-white container mx-auto my-2 flex gap-2">
      ...
      <Marquee speed={100} pauseOnHover className="w-28">
      ...
      <ul className="justify-end items-center hidden md:flex gap-5 ">
        <li role="menuitem" className="nav-item">
          <Link href="/signup" className="nav-link font-bold">SignUp</Link>
        </li>
        ...
        <div className="container m-auto flex flex-wrap items-center justify-between py-6 gap-6 md:py-4 md:gap-0 relative">
          ...
          <div className="w-full flex justify-between items-center md:w-max md:px-0">
            <a href="#" aria-label="logo">
              <img src="/assets/logo/logo-02.png" className="" alt="Float Fashion" width="144" height="68" />
            </a>
          ...
          <label role="button" for="toggle_nav" className="fixed w-full z-30 h-full top-0 left-0 bg-gray-700 bg-opacity-40 hidden peer-checked:block md:peer-checked:hidden"></label>
          ...
          <div className="flex z-50 flex-col md:flex-row justify-between 
            ...
            <div className="flex md:hidden w-full pb-5">
              <Link href="/" aria-label="logo">
                <img src="/assets/logo/logo-02.png" className="w-36" alt="Float Fashion" width="144" height="68" />
              </Link>
            </div>
              ...
              <ul className="space-y-8 tracking-wide font-medium md:flex md:space-y-0">
                ...
                <li>
                  <Link href="/contact" className="block md:px-3 group">
                    <div className=" relative text-white
                                                    before:absolute before:-inset-2 before:w-full before:h-0.5 before:origin-left before:mx-auto before:mt-auto before:rounded-full">
                      <span className="transition group-hover:text-orange-700">Contact</span>
                    </div>
                  </Link>
                </li>
              </ul>
            ...
            <ul className="flex md:hidden gap-2 items-center">
              <li className="nav-item">
                <Link href="/signUp" className="block md:px-3 group text-white">SignUp</Link>
              </li>
              <li className="nav-item flex items-center gap-1">
                <Link href="/login" className="text-white gap-2 block md:px-3 group">
                  <span>Login</span>
                </Link>
              </li>
            </ul>
